...
-- CHECK (컬럼명 비교연산자 비교값)
-- 주의사항 : 비교값은 리터럴만 사용할 수 있음, 변하는 값이나 함수 사용 못함.
...
CREATE TABLE USER_TEST (
	...
	USER_ID VARCHAR(20) CONSTRAINT UK_USER_TEST_ID UNIQUE,
	USER_PWD VARCHAR(30) CONSTRAINT NN_USER_TEST_PWD UNIQUE,
	PNO CHAR(14) CONSTRAINT NK_USER_TEST_PNO NOT NULL,
	GENDER VARCHAR2(3) CONSTRAINT CK_USER_TEST_GENDER CHECK(GENDER IN ('남','여')),
	PHONE VARCHAR2(30),
	ADDRESS VARCHAR(100),
	STATUS VARCHAR(10) DEFAULT 'N' CONSTRAINT NN_USER_TEST_STATUS NOT NULL,
...
VALUES(1, 'user01', 'pass01', '870101-1234567', '남', '010-1234-1234', '서울시 강남구', 'N');

INSERT INTO USER_TEST
VALUES(2, 'user02', 'pass02', '681231-1262567', '여', '010-1111-2222', '서울시 중구', 'Y');

INSERT INTO USER_TEST
VALUES(3, 'user03', 'pass03', '990123-1535767', '여', '010-4444-3333', '경기도 성남구', 'N');

INSERT INTO USER_TEST
VALUES(4, 'user04', 'pass04', '741204-1234567', '남', '010-4576-7777', '부산시 중구', 'Y');

INSERT INTO USER_TEST
VALUES(5, 'user05', 'pass05', '889421-1212367', '남', '010-1124-7254', '서울시 서초구', 'N');
...
-- 참조 테이블 SAL_GRADE, 참조컬럼은 SAL_GRADE 의 기본키
