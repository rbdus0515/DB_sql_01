/*
 * 
 * DCL ( Data Control Languge ) : 데이터를 다루기 위한 권한을 다루는 언어
 * 
 ...
 * 		CREATE VIEW	 		: 뷰 생성 권한
 * 		CREATE SEQUNCE 		: 시퀀스 생성권한
 * 		CREATE PROCUDUER 	: 함수(프로시져) 생성 권한
 * 		CREATE USER 		: 사용자(계정)생성 권한
 * 
 * 		DROP USER 			: 사용자(계정) 삭제 권한
 * 
 * 2) 객체 권한 : 득정 객체를 조작할 수 있는 권한
 * 
 * 		권한 종류				설정 객체
 * 
...
-- 2. (kh) cky_sample 계정에 EMPLOYEE 테이블 조회 권한 부여
